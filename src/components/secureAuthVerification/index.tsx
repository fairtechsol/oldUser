        ...
        <ReportContainer  title="Secure Auth Verification">
            <div className="secureAuth px-2 mt-md-5 mb-5 ml-8">
                <Row className="justify-content-center text-center">
                    <Col lg={6}>
                        <div
                            className={`secureAuth-status d-flex align-items-center ${isMobile
                                ? "mt-2 justify-content-between"
                                : "justify-content-center"
                                } `}
                        >
                            <h3
                                className={`m-10 me-2 fw-normal ${isMobile ? "title-16" : "title-24"
                                    }`}
                            >
                                Secure Auth Verification Status:{" "} 
                            </h3>
                            <span
                                className={`pdf ${isMobile ? "title-14" : "title-16"
                        ...
                        <div id="left-tabs-example">
                            ...
                            >
                                <ToggleButton
                                    ...
                                    bsPrefix={`auth-verification-btn btn-check ${selectedValue === 1 ? teamStatus.active : ""
                                        }`}
                                    id="mobileapp"
                                    value={1}
                                >
                                ...
                                <ToggleButton
                                    className="auth-verification-btn-box"
                                    bsPrefix={`auth-verification-btn btn-check ${selectedValue === 2 ? teamStatus.active : ""
                                        }`}
                                    id="telegram"
                                    value={2}
                                >
                                ...
                                <>
                                    ...
                                    <Form className="getConection w-100">
                                        <div className="d-flex  justify-content-center">
                                            ...
                                            />
                                            <CustomSecureButton
                                                className={`ms-2 ${!isMobile && "bg-primaryBlue"
                                                    } border-0`}
                                            >
                                                Get Connection Id
                                            </CustomSecureButton>{" "}
