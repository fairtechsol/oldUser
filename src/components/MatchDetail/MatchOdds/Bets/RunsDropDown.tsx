    ...
    const calculatePosition = () => {
      if (dropdownRef.current) {
        ...
        if (parentElement) {
          ...
          const totalDropdownHeight = headerHeight + estimatedContentHeight + 2;

          const spaceBelow = viewportHeight - parentRect.bottom - 35;
          const spaceAbove = parentRect.top - 35;

          const shouldOpenUpward =
            spaceBelow < totalDropdownHeight &&
            spaceAbove >= totalDropdownHeight;
